    ...
    <section ref={ref} id="inicio" className="relative h-screen flex items-center justify-center overflow-hidden bg-desert-950">
      ...
      >
        ...
        >
          ...
          <span className="text-sm font-light tracking-widest text-white/90 uppercase">Huasco, Atacama</span>
        ...
        >
          ...
          <a href="#cabanas" className="group flex items-center justify-center gap-3 px-8 py-4 sm:px-10 sm:py-5 bg-white/5 backdrop-blur-lg border border-white/15 text-white rounded-full text-base sm:text-lg font-light hover:bg-white/10 hover:border-white/30 transition-all duration-300 w-full sm:w-auto">
